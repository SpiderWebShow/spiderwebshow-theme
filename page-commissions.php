...
<!-- 		<div class="ribbon-wrapper-green"><div class="ribbon-green">NEW</div></div> -->
	...
	<p><a class="pure-button pure-button-primary" href="<?php echo $makerProfileUrl; ?>" title="">Click here to read more about the author and how they made this work &raquo;</a></p>
